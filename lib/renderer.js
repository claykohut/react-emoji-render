...
function toArray(text) {
  ...
  function replaceUnicodeEmoji(match, i) {
    ...
    var codepoint = options.codepoint || (0, _unicodeToCodepoint2.default)(match);
...
function Emoji(_ref) {
  var text = _ref.text,
      ...
      rest = _objectWithoutProperties(_ref, ["text", "onlyEmojiClassName", "codepoint", "options", "className"]);
  ...
  var output = codepoint ? getCodepoint(codepoint, options) : toArray(text, options);
...
Emoji.propTypes = {
  ...
  codepoint: _propTypes2.default.string,
